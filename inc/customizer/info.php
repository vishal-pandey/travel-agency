...
function travel_agency_customizer_theme_info( $wp_customize ) {
    ...
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Recommended plugins', 'travel-agency' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/documentation/travel-agency-documentation/#Installing_Recommended_Plugins' ) . '" target="_blank">' . __( 'here', 'travel-agency' ) . '</a></span>';
	$theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'View documentation', 'travel-agency' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/documentation/travel-agency-documentation/' ) . '" target="_blank">' . __( 'here', 'travel-agency' ) . '</a></span>';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Support ticket', 'travel-agency' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/support-ticket/' ) . '" target="_blnak">' . __( 'here', 'travel-agency' ) . '</a></span>';
